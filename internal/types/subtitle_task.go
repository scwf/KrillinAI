...
1. 将原文翻译为%s，确保译文流畅、自然，达到专业翻译水平，保持意思相同。
...
3. 确保拆分后的句子合并后与原文一致，且不遗漏任何字词。
4. 对每个拆分的句子分别翻译，确保不遗漏或修改任何字词。
5. 将每对翻译后的句子与原句用独立编号表示，并分别以方括号[]包裹内容。
6. 输出的翻译与原文应保持对应，严格按照原文顺序呈现，不得有错位，与原文表达的意思保持一致。
7. 不管内容是正式还是非正式，都要翻译。
